...
| ¿Qué tokens de la plantilla NO tienen fila en ? |  — congelado, uno nuevo por corrida. **Existe porque hasta el 22/08 esa pregunta se contestaba mirando decks generados** —donde el  del motor y el  que tipea el equipo son indistinguibles ()— **o documentos que resultaron estar viejos** (, ). Esto lo lee del registro contra la **plantilla viva**. ⚠ **«Sin fila» NO es «publica »**: eso es otra pregunta y necesita una corrida | nadie edita; se crea uno nuevo |
